...
export default function App() {
  ...
  return (
    <div className="h-[400px] bg-slate-100 mt-10 flex justify-center items-center gap-20 p-[120px 0px 70px]">
      <div className="content w-64 h-64  flex flex-col  gap-4 justify-center items-center  rounded-lg  ">
        <svg viewBox="0 0 24 24" class="size-20">
      ...
      <div className="content w-64 h-64  flex flex-col gap-4 justify-center items-center p-6 rounded-lg ">
        <svg viewBox="0 0 24 24" class="size-20">
